...
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/resource/OneTech/plugins/OwlCarousel2-2.2.1/owl.carousel.css">
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/resource/OneTech/plugins/OwlCarousel2-2.2.1/owl.theme.default.css">
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/resource/OneTech/plugins/OwlCarousel2-2.2.1/animate.css">
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/resource/OneTech/plugins/slick-1.8.0/slick.css">
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/resource/OneTech/styles/main_styles.css">
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/resource/OneTech/styles/responsive.css">
			...
			<div class="container">
				<div class="row">
					<div class="col d-flex flex-row">
						<div class="top_bar_contact_item"><div class="top_bar_icon"></div><a href="logout.do">+38 068 005 3570</a></div>
						<div class="top_bar_contact_item"><div class="top_bar_icon"><img src="images/mail.png" alt=""></div><a href="/SELLPHONE/article/list.do">fastsales@gmail.com</a></div>
						<div class="top_bar_content ml-auto">
							...
							<div class="top_bar_user">
								...
								<div><a href="logout.do">Log out</a></div>
								</c:if>
							</div>
						</div>
					</div>
				...
				<div class="row">
					...
					<div class="col-lg-2 col-sm-3 col-3 order-1">
						<div class="logo_container">
							<div class="logo"><a href="#">SELLPHONE</a></div>
						</div>
					</div>
						...
						<div class="main_nav_content d-flex flex-row">
							...
							<div class="main_nav_menu ml-auto">
								<ul class="standard_dropdown main_nav_dropdown">
									...
									<li><a href="/SELLPHONE/article/list.do">Q&A<i class="fas fa-chevron-down"></i></a></li>
									<li><a href="contact.html">Contact<i class="fas fa-chevron-down"></i></a></li>
								</ul>
							</div>
					...
					<div class="col">
						...
						<div class="page_menu_content">
							...
							<ul class="page_menu_nav">
								...
								<li class="page_menu_item"><a href="blog.html">Q&A<i class="fa fa-angle-down"></i></a></li>
...
<script src="${pageContext.request.contextPath}/resource/OneTech/plugins/OwlCarousel2-2.2.1/owl.carousel.js"></script>
<script src="${pageContext.request.contextPath}/resource/OneTech/plugins/slick-1.8.0/slick.js"></script>
<script src="${pageContext.request.contextPath}/resource/OneTech/plugins/easing/easing.js"></script>
<script src="${pageContext.request.contextPath}/resource/OneTech/js/custom.js"></script>
</body>
