			...
			<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
				<form action="seller_join.do" class="login100-form validate-form" method="post" >
					...
					<div class="wrap-input100 validate-input m-b-23" data-validate = "Username is reauired">
						...
						<input class="input100" type="text" name="seller_id" value="${param.seller_id}" placeholder="id">
						<span class="focus-input100" data-symbol="&#xf206;"></span>
					</div>

					<div class="wrap-input100 validate-input m-b-23" data-validate = "Username is reauired">
						<span class="label-input100">이름</span>
						<input class="input100" type="text" name="seller_name" value="${param.seller_name}" placeholder="phone number">
						<span class="focus-input100" data-symbol="&#xf206;"></span>
					</div>
					...
					<div class="wrap-input100 validate-input m-b-23" data-validate = "Username is reauired">
						...
						<input class="input100" type="text" name="seller_address" value="${param.seller_address}" placeholder="address">
						<span class="focus-input100" data-symbol="&#xf206;"></span>
					</div>
					
					<div class="wrap-input100 validate-input m-b-23" data-validate = "Username is reauired">
						<span class="label-input100">이메일</span>
						<input class="input100" type="text" name="seller_email" value="${param.seller_email}" placeholder="email">
						<span class="focus-input100" data-symbol="&#xf206;"></span>
					</div>
					
					<div class="wrap-input100 validate-input m-b-23" data-validate = "Username is reauired">
						<span class="label-input100">전화번호</span>
						<input class="input100" type="text" name="seller_phone"  value="${param.seller_phone}"  placeholder="phone number">
						<span class="focus-input100" data-symbol="&#xf206;"></span>
					</div>
