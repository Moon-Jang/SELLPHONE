	...
	<div class="limiter">
		<div class="container-login100" ;>
			<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
				<form  action="seller_login.do" class="login100-form validate-form" method="post" >
					...
					<div class="wrap-input100 validate-input m-b-23" data-validate = "Username is reauired">
						...
						<input class="input100" type="text" name="seller_id" placeholder="Type your username">
					...
					<div class="wrap-input100 validate-input" data-validate="Password is required">
						...
						<input class="input100" type="password" name="seller_pw" placeholder="Type your password">
						<span class="focus-input100" data-symbol="&#xf190;"></span>
					</div>
