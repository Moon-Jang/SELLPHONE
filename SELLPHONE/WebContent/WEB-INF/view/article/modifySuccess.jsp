		...
		<div class="container-login100" ;>
			<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
				<form class="login100-form validate-form">
					...
					<div name="qna_list" class="container-login100-form-btn ">
						<div class="wrap-login100-form-btn">
							<div class="login100-form-bgbtn"></div>
							${ctxPath = pageContext.request.contextPath ; ''}
							<button type="button"  onclick="location.href='${ctxPath}/article/list.do'"class="login100-form-btn">
								게시글 목록 보기
							</button>
							</div>
					</div>
					<br>
					<div name="qna_content" class="container-login100-form-btn ">
						<div class="wrap-login100-form-btn">
							<div class="login100-form-bgbtn"></div>
							${ctxPath = pageContext.request.contextPath ; ''}		
							<button type="button"  onclick="location.href='${ctxPath}/article/read.do?no=${modReq.articleNumber}'"class="login100-form-btn">
								게시글 내용 보기
							</button>
						</div>
					</div>
