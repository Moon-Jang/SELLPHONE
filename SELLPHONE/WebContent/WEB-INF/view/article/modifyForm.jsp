				...
				<div class="row">
					<div class="col-lg-10 offset-lg-1">
						<div class="contact_form_container">
							<div class="contact_form_title">QnA를 수정합니다.</div>
							...
							<form action="/SELLPHONE/article/modify.do" method="post">
								<div
									...
									<input type="text" id="contact_form_title" name="title"
										...
										placeholder="Please modify your message" required="required"
								...
								<div class="contact_form_text">
									<textarea id="contact_form_message"
										...
										required="required" data-error="Please, modify your message.">${modReq.content}</textarea>
								</div>

								<div class="contact_form_button">
									<button type="submit" class="button contact_submit_button">Modify</button>
								</div>
							</form>
						</div>
					</div>
