...
<link rel="stylesheet" type="text/css"
	href="${pageContext.request.contextPath}/resource/OneTech/styles/bootstrap4/bootstrap.min.css">
<link
	href="${pageContext.request.contextPath}/resource/OneTech/plugins/fontawesome-free-5.0.1/css/fontawesome-all.css"
	rel="stylesheet" type="text/css">
<link rel="stylesheet" type="text/css"
	href="${pageContext.request.contextPath}/resource/OneTech/plugins/OwlCarousel2-2.2.1/owl.carousel.css">
<link rel="stylesheet" type="text/css"
	href="${pageContext.request.contextPath}/resource/OneTech/plugins/OwlCarousel2-2.2.1/owl.theme.default.css">
<link rel="stylesheet" type="text/css"
	href="${pageContext.request.contextPath}/resource/OneTech/plugins/OwlCarousel2-2.2.1/animate.css">
<link rel="stylesheet" type="text/css"
	href="${pageContext.request.contextPath}/resource/OneTech/plugins/slick-1.8.0/slick.css">
<link rel="stylesheet" type="text/css"
	href="${pageContext.request.contextPath}/resource/OneTech/styles/main_styles.css">
<link rel="stylesheet" type="text/css"
	href="${pageContext.request.contextPath}/resource/OneTech/styles/responsive.css">
<link
	href="${pageContext.request.contextPath}/resource/Onetech/plugins/fontawesome-free-5.0.1/css/fontawesome-all.css"
	rel="stylesheet" type="text/css">
<link rel="stylesheet" type="text/css"
	href="${pageContext.request.contextPath}/resource/OneTech/styles/contact_styles.css">
<link rel="stylesheet" type="text/css"
	href="${pageContext.request.contextPath}/resource/OneTech/styles/contact_responsive.css">
				...
				<div class="row">
					<div class="col-lg-10 offset-lg-1">
						<div class="contact_form_container">
							<div class="contact_form_title"><pre>No${articleData.article.qna_idx}.Q&A</pre></div>


							<form action="/SELLPHONE/article/modify.do" method="post">
								<div
									class="contact_form_inputs d-flex flex-md-row flex-column justify-content-between align-items-between">
									<input type="hidden" name="no" value="${modReq.articleNumber}">
									<input type="text" id="contact_form_title" name="title" style="font-weight: 30px"
										value="${articleData.article.qna_title}" class="contact_form_title input_field"
										placeholder="${articleData.article.qna_title}" required="required"
										data-error="Name is required." style="color: black"readOnly>
										<input type="text" id="contact_form_title" name="title"
										value="${modReq.title}" class="contact_form_title input_field"
										placeholder="${articleData.article.writer.name}" required="required"
										data-error="Name is required." style="color: black"readOnly>
								...
								<div class="contact_form_text">
									<textarea id="contact_form_message"
										class="text_field contact_form_message" name="content"
										rows="4" placeholder="Please, write your message"
										required="required" data-error="Please, modify your message." readOnly>${articleData.article.qna_question}</textarea>
								</div>

								<div class="contact_form_button">
								<c:set var="pageNo" value="${empty param.pageNo ? '1' : param.pageNo}" />
									<button type="button"  onclick="location.href='list.do?pageNo=${pageNo}'"class="button contact_submit_button">목록 보기</button>
								</div>
							</form>
						</div>
					</div>
