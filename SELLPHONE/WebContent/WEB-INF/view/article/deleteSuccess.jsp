...
<link rel="stylesheet" type="text/css"
	href="${pageContext.request.contextPath}/resource/Order/styles/bootstrap4/bootstrap.min.css">
<link href="${pageContext.request.contextPath}/resource/Order/plugins/fontawesome-free-5.0.1/css/fontawesome-all.css"
	rel="stylesheet" type="text/css">
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/resource/Order/styles/cart_styles.css">
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/resource/Order/styles/cart_responsive.css">
					...
					<div class="col d-flex flex-row">
						<div class="top_bar_content ml-auto">
							...
							<div class="top_bar_user">
								...
								<div><a href="../Login/SelectSign.html">회원가입</a></div>
								<div><a href="../Login/SelectLogin.html">로그인</a></div>
								<div><a href="../OneTech/board.html">게시판</a></div>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="row">
						...
						<div class="col-lg-2 col-sm-3 col-3 order-1">
							<div class="logo_container">
								<div class="logo">
									<a href=../OneTech/index.html>SellPhone</a>
								</div>
							</div>
						</div>
				...
				<div class="row">
					<div class="col-lg-10 offset-lg-1">
						<div class="cart_container">
							<form class="login100-form validate-form" style="text-align: center">
								<div class="cart_title2"> <br>게시물이 삭제되었습니다.</div>
								<div class="cart_items">
								<div class="cart_buttons">
					<button type="button" class="button cart_button_checkout"
						onclick="location.href='list.do'">게시물 목록보기</button>
				</div>
									<!-- <ul class="cart_list"> -->
...
<!-- 
				...
				<div class="row">
					...
					<div class="col-lg-3 footer_col">
						<div class="footer_column footer_contact">
							...
							<div class="footer_phone">+82 031 467 0700 </div>
	...
	<script src="${pageContext.request.contextPath}/resource/Order/js/jquery-3.3.1.min.js"></script>
	<script src="${pageContext.request.contextPath}/resource/Order/styles/bootstrap4/popper.js"></script>
	<script src="${pageContext.request.contextPath}/resource/Order/styles/bootstrap4/bootstrap.min.js"></script>
	<script src="${pageContext.request.contextPath}/resource/Order/plugins/greensock/TweenMax.min.js"></script>
	<script src="${pageContext.request.contextPath}/resource/Order/plugins/greensock/TimelineMax.min.js"></script>
	<script src="${pageContext.request.contextPath}/resource/Order/plugins/scrollmagic/ScrollMagic.min.js"></script>
	<script src="${pageContext.request.contextPath}/resource/Order/plugins/greensock/animation.gsap.min.js"></script>
	<script src="${pageContext.request.contextPath}/resource/Order/plugins/greensock/ScrollToPlugin.min.js"></script>
	<script src="${pageContext.request.contextPath}/resource/Order/plugins/easing/easing.js"></script>
	<script src="${pageContext.request.contextPath}/resource/Order/js/cart_custom.js"></script>
</body>
