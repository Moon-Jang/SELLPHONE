				...
				<div class="row">
					<div class="col-lg-10 offset-lg-1">
						<div class="contact_form_container">
							<div class="contact_form_title">QnA를 입력하세요.</div>


							<form action="/SELLPHONE/article/write.do" method="post">
								<div
									class="contact_form_inputs d-flex flex-md-row flex-column justify-content-between align-items-between">

									<input type="text" id="contact_form_title" name="qna_title"
										value="${param.title}" class="contact_form_title input_field"
								...
								<div class="contact_form_text">
									<textarea id="contact_form_message"
										class="text_field contact_form_message" name="qna_question"
										rows="4" placeholder="Please, write your message"
										required="required" data-error="Please, write your message.">${param.title}</textarea>
								</div>

								<div class="contact_form_button">
									<button type="submit" class="button contact_submit_button">Send
										QnA</button>
								</div>
							</form>
						</div>
